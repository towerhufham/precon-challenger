...
export const threadEffects = (gs: GameState, effects: Effect[], ctx: AbilityContext, selections: Selections): EffectResult => {
...
export const getTriggersFromAtoms = (result: EffectResult): [number, Ability][] => {
  return [...pipe(
    result.atoms,
...
export const resolveTriggerCascade = (currentResult: EffectResult): EffectResult => {
